"""HTML artifact builder rendering responsive single-page digest."""
...
def render_html_page(aggregated_data: dict[str, Any]) -> str:
    """Generate complete self-contained HTML5 string."""
  ...
  <div class="container">
    <header class="main-header">
      ...
      <div class="header-actions">
        <a href="./latest.json" class="api-pill" target="_blank" rel="noopener">
          <span>&lt;/&gt;</span> latest.json
        </a>
...
def build_html(aggregated_data: dict[str, Any], output_path: str = "public/index.html") -> None:
    """Build and write single-page HTML artifact atomically."""
    output_dir = os.path.dirname(os.path.abspath(output_path))
    os.makedirs(output_dir, exist_ok=True)

    content = render_html_page(aggregated_data)
